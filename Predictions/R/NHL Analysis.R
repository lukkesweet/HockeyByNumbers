...
load(file = here('Predictions', 'Data', 'Schedule1920.Rda'))
load(file = here('Predictions', 'Data', 'Standings1819.Rda'))
...
## Save scores
save(Schedule1920, file = here('Predictions', 'Data', 'Schedule1920.Rda'))
...
load(file = here('Predictions', 'Data', 'ArizonaCoyotes.Rda'))
load(file = here('Predictions', 'Data', 'BostonBruins.Rda'))
load(file = here('Predictions', 'Data', 'BuffaloSabres.Rda'))
load(file = here('Predictions', 'Data', 'CalgaryFlames.Rda'))
load(file = here('Predictions', 'Data', 'CarolinaHurricanes.Rda'))
load(file = here('Predictions', 'Data', 'ChicagoBlackhawks.Rda'))
load(file = here('Predictions', 'Data', 'ColoradoAvalanche.Rda'))
load(file = here('Predictions', 'Data', 'DallasStars.Rda'))
load(file = here('Predictions', 'Data', 'DetroitRedWings.Rda'))
load(file = here('Predictions', 'Data', 'EdmontonOilers.Rda'))
load(file = here('Predictions', 'Data', 'LosAngelesKings.Rda'))
load(file = here('Predictions', 'Data', 'MontrealCanadiens.Rda'))
load(file = here('Predictions', 'Data', 'NewJerseyDevils.Rda'))
load(file = here('Predictions', 'Data', 'NewYorkIslanders.Rda'))
load(file = here('Predictions', 'Data', 'NewYorkRangers.Rda'))
load(file = here('Predictions', 'Data', 'PhiladelphiaFlyers.Rda'))
load(file = here('Predictions', 'Data', 'PittsburghPenguins.Rda'))
load(file = here('Predictions', 'Data', 'St.LouisBlues.Rda'))
load(file = here('Predictions', 'Data', 'TorontoMapleLeafs.Rda'))
load(file = here('Predictions', 'Data', 'VancouverCanucks.Rda'))
load(file = here('Predictions', 'Data', 'WashingtonCapitals.Rda'))
load(file = here('Predictions', 'Data', 'SanJoseSharks.Rda'))
load(file = here('Predictions', 'Data', 'OttawaSenators.Rda'))
load(file = here('Predictions', 'Data', 'TampaBayLightning.Rda'))
load(file = here('Predictions', 'Data', 'AnaheimDucks.Rda'))
load(file = here('Predictions', 'Data', 'FloridaPanthers.Rda'))
load(file = here('Predictions', 'Data', 'NashvillePredators.Rda'))
load(file = here('Predictions', 'Data', 'WinnipegJets.Rda'))
load(file = here('Predictions', 'Data', 'ColumbusBlueJackets.Rda'))
load(file = here('Predictions', 'Data', 'MinnesotaWild.Rda'))
load(file = here('Predictions', 'Data', 'ClevelandBarons.Rda'))
load(file = here('Predictions', 'Data', 'BrooklynAmericans.Rda'))
load(file = here('Predictions', 'Data', 'MontrealMaroons.Rda'))
load(file = here('Predictions', 'Data', 'MontrealWanderers.Rda'))
load(file = here('Predictions', 'Data', 'PhiladelphiaQuakers.Rda'))
load(file = here('Predictions', 'Data', 'St.LouisEagles.Rda'))
load(file = here('Predictions', 'Data', 'VegasGoldenKnights.Rda'))
...
load(file = here('Predictions', 'Data', 'Standings.Rda'))
Sch[,1] = as.Date(Sch[,1])
...
Eh = round(1 / (1 + 10 ^ (-(ELOh - ELOv + homeice)/400)), 4)
...
save(ArizonaCoyotes, file = here('Predictions', 'Data', 'ArizonaCoyotes.Rda'))
save(BostonBruins, file = here('Predictions', 'Data', 'BostonBruins.Rda'))
save(BuffaloSabres, file = here('Predictions', 'Data', 'BuffaloSabres.Rda'))
save(CalgaryFlames, file = here('Predictions', 'Data', 'CalgaryFlames.Rda'))
save(CarolinaHurricanes, file = here('Predictions', 'Data', 'CarolinaHurricanes.Rda'))
save(ChicagoBlackhawks, file = here('Predictions', 'Data', 'ChicagoBlackhawks.Rda'))
save(ColoradoAvalanche, file = here('Predictions', 'Data', 'ColoradoAvalanche.Rda'))
save(DallasStars, file = here('Predictions', 'Data', 'DallasStars.Rda'))
save(DetroitRedWings, file = here('Predictions', 'Data', 'DetroitRedWings.Rda'))
save(EdmontonOilers, file = here('Predictions', 'Data', 'EdmontonOilers.Rda'))
save(LosAngelesKings, file = here('Predictions', 'Data', 'LosAngelesKings.Rda'))
save(MontrealCanadiens, file = here('Predictions', 'Data', 'MontrealCanadiens.Rda'))
save(NewJerseyDevils, file = here('Predictions', 'Data', 'NewJerseyDevils.Rda'))
save(NewYorkIslanders, file = here('Predictions', 'Data', 'NewYorkIslanders.Rda'))
save(NewYorkRangers, file = here('Predictions', 'Data', 'NewYorkRangers.Rda'))
save(PhiladelphiaFlyers, file = here('Predictions', 'Data', 'PhiladelphiaFlyers.Rda'))
save(PittsburghPenguins, file = here('Predictions', 'Data', 'PittsburghPenguins.Rda'))
save(St.LouisBlues, file = here('Predictions', 'Data', 'St.LouisBlues.Rda'))
save(TorontoMapleLeafs, file = here('Predictions', 'Data', 'TorontoMapleLeafs.Rda'))
save(VancouverCanucks, file = here('Predictions', 'Data', 'VancouverCanucks.Rda'))
save(WashingtonCapitals, file = here('Predictions', 'Data', 'WashingtonCapitals.Rda'))
save(SanJoseSharks, file = here('Predictions', 'Data', 'SanJoseSharks.Rda'))
save(OttawaSenators, file = here('Predictions', 'Data', 'OttawaSenators.Rda'))
save(TampaBayLightning, file = here('Predictions', 'Data', 'TampaBayLightning.Rda'))
save(AnaheimDucks, file = here('Predictions', 'Data', 'AnaheimDucks.Rda'))
save(FloridaPanthers, file = here('Predictions', 'Data', 'FloridaPanthers.Rda'))
save(NashvillePredators, file = here('Predictions', 'Data', 'NashvillePredators.Rda'))
save(WinnipegJets, file = here('Predictions', 'Data', 'WinnipegJets.Rda'))
save(ColumbusBlueJackets, file = here('Predictions', 'Data', 'ColumbusBlueJackets.Rda'))
save(MinnesotaWild, file = here('Predictions', 'Data', 'MinnesotaWild.Rda'))
save(ClevelandBarons, file = here('Predictions', 'Data', 'ClevelandBarons.Rda'))
save(BrooklynAmericans, file = here('Predictions', 'Data', 'BrooklynAmericans.Rda'))
save(MontrealMaroons, file = here('Predictions', 'Data', 'MontrealMaroons.Rda'))
save(MontrealWanderers, file = here('Predictions', 'Data', 'MontrealWanderers.Rda'))
save(PhiladelphiaQuakers, file = here('Predictions', 'Data', 'PhiladelphiaQuakers.Rda'))
save(St.LouisEagles, file = here('Predictions', 'Data', 'St.LouisEagles.Rda'))
save(VegasGoldenKnights, file = here('Predictions', 'Data', 'VegasGoldenKnights.Rda'))
save(Schedule1920, file = here('Predictions', 'Data', 'Schedule1920.Rda'))
