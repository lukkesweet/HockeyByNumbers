...
Welcome to Hockey By Numbers!  This site will focus on looking at the game of hockey through the lens of statistics.  A great place to start is with the basic stats available for teams, players, and goalies from the [NHL](www.NHL.com).
...
All the data in this article was exported from the [NHL](www.NHL.com/stats).  Be on the look out for Part 2 where we'll dive into some other statistics.